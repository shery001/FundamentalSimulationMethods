...
void ExportData(vector<double> *time, vector<double> *temp, string path){
...
// Store the new values in the vectors
	...
	string exp_path = "data_ex1_b_15.dat";
	ExportData(time_steps, temp_steps, exp_path);
}
